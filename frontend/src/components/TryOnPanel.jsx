...
const T = {
  ...
  viewport: { position: "relative", background: COLORS.cardBg, borderRadius: 12, overflow: "hidden", border: `1px solid ${COLORS.border}`, height: 380, display: "flex", alignItems: "center", justifyContent: "center" },
  ...
  picker: { background: COLORS.cardBg, border: `1px solid ${COLORS.border}`, borderRadius: 12, display: "flex", flexDirection: "column", padding: 18 },
