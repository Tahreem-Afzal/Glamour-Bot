          ...
          return (
            <div
              ...
              style={{
                ...
                borderColor: isSel ? col.accent : COLORS.border,
              }}
...
const T = {
  ...
  subNavBtn: { background: "none", border: `1px solid ${COLORS.border}`, color: COLORS.textSecondary, padding: "6px 16px", cursor: "pointer", fontSize: 12, borderRadius: 20 },
  ...
  tryonRoot: { display: "flex", flex: 1, overflow: "hidden" },
  leftPane: { flex: "0 0 64%", display: "flex", flexDirection: "column", padding: 18, gap: 14, overflowY: "auto" },
  modeToggle: { display: "flex", gap: 0, border: `1px solid ${COLORS.border}`, borderRadius: 20, overflow: "hidden", alignSelf: "flex-start" },
  ...
  viewport: { position: "relative", background: COLORS.surfaceAlt, borderRadius: 12, overflow: "hidden", border: `1px solid ${COLORS.border}`, aspectRatio: "4/3", display: "flex", alignItems: "center", justifyContent: "center" },
  ...
  picker: { flex: "0 0 36%", background: COLORS.surface, borderLeft: `1px solid ${COLORS.border}`, display: "flex", flexDirection: "column", padding: 14, overflow: "hidden" },
  ...
  chip: { background: "none", border: `1px solid ${COLORS.border}`, color: COLORS.textSecondary, padding: "3px 12px", fontSize: 11, cursor: "pointer", borderRadius: 20 },
  chipActive: { color: COLORS.accent, borderColor: COLORS.accent, background: COLORS.accentSoftBg },
  garmentList: { overflowY: "auto", display: "flex", flexDirection: "column", gap: 6, flex: 1 },
  emptyMsg: { color: COLORS.textMuted, fontSize: 12, textAlign: "center", padding: 24 },
  garmentCard: { display: "flex", alignItems: "center", gap: 10, border: "1px solid", borderRadius: 10, padding: "9px 11px", cursor: "pointer" },
  ...
  catalogPage: { padding: "20px 28px", overflowY: "auto" },
  catalogGrid: { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(210px, 1fr))", gap: 16 },
  catalogCard: { background: COLORS.surface, border: `1px solid ${COLORS.border}`, borderRadius: 12, overflow: "hidden" },
  catalogThumb: { height: 180, display: "flex", alignItems: "center", justifyContent: "center" },
  uploadPage: { padding: "24px 32px", maxWidth: 700, margin: "0 auto", width: "100%", overflowY: "auto" },
