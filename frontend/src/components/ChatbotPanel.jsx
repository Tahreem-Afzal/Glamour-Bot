...
const T = {
  en: {
    eyebrow: "Chatbot",
    title: "Share your event, choose the date, and let GalmourBot create a complete, professionally styled look just for you.",
    ...
    greeting: "Hi! I'm GalmourBot — ask me about outfits, occasions, or fashion advice. You can write in English or Roman Urdu.",
    ...
    thinking: "GalmourBot is thinking…",
    stopSpeaking: "Stop GalmourBot speaking",
  ...
  ur: {
    eyebrow: "چیٹ بوٹ",
    title: "اپنے موقع کا انتخاب کریں، تاریخ چنیں، اور GalmourBot کو آپ کے لیے مکمل، پیشہ ورانہ انداز میں تیار کردہ لک بنانے دیں۔",
    ...
    greeting: "السلام علیکم! میں GalmourBot ہوں — مجھ سے لباس، مواقع، یا فیشن کے مشورے پوچھیں۔ آپ انگریزی یا رومن اردو میں لکھ سکتے ہیں۔",
    ...
    thinking: "GalmourBot سوچ رہا ہے…",
    stopSpeaking: "GalmourBot کی آواز روکیں",
